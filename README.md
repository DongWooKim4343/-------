...
# 3. 분석 결과 및 해석
![image](https://github.com/DongWooKim4343니다. 그나마 BMI 지수의 상관계수가 0.1 수준으로 다른 두 데이터 보다는 높은 수준이지만 이정도 차이는 연구가 개개인의 설문으로 인한 데이터 수집으로 직접 측정시와 똑같은 환경으로 횟수 측정을 못한 오차를 감안할 때, 큰 의미는 없다는 생각이 듭니다.
